...
def add_standard_hyperparameters(architecture):
    ...
    architecture.add_hyperparameter('silence_percentage', t=float, default=10.0, help="How much of the training data should be silence.")
    architecture.add_hyperparameter('unknown_percentage', t=float, default=10.0, help="How much of the training data should be unknown words.")
    architecture.add_hyperparameter('validation_percentage', t=float,default=10.0, help='What percentage of wavs to use as a validation set.')
    architecture.add_hyperparameter('testing_percentage', t=float,default=10.0, help='What percentage of wavs to use as a test set.')
