...
class CNNModule(nn.Module):
    def __init__(self):
        ...
        self.bn = nn.BatchNorm2d(1, eps= 1e-05,  momentum=None, track_running_stats=False)
        self.cnn1 = nn.Conv2d(in_channels=1,out_channels=64,kernel_size=4,stride=1,padding=(0,0))#(2,1))
        self.relu1=nn.ReLU()
        ...
        self.cnn2=nn.Conv2d(in_channels=64,out_channels=64,kernel_size=4,stride=1,padding=0)
        self.relu2=nn.ReLU()
