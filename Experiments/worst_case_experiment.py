...
class worst_case_experiment:
    ...
    def train_grid():
        ...
        speech1 = configure(speech, {"beta_robustness": 0.5, "attack_size_mismatch":0.2})
        ...
        cnn_grid = cnn_grid0 + cnn_grid1 + cnn_grid2 + cnn_grid3 + cnn_grid5
    ...
    def visualize():
        ...
        def grid_plot(table, axes_dict):
            ...
            for i0 in range(shape[0]):
                ...
                for i1 in range(shape[1]):
                    ...
                    colors = ["#4c84e6","#fc033d","#03fc35","#000000","#9b32a8", "#aaa2b8"]
        ...
        def plot(boundary_loss, loss_or_acc):
            ...
            independent_keys = ["architecture","n_attack_steps","attack_size", Table.Deviation_Var({"beta_robustness":0.0, "awp":False, "dropout_prob":0.0, "optimizer":"adam", "noisy_forward_std":0.0}, label="Method")]
