...
class mismatch_experiment:
    ...
    def train_grid():
        ...
        ecg = ecg0 + ecg1 + ecg2 + ecg3 + ecg4  + ecg6 + ecg7
        ...
        speech = speech0 + speech1 + speech2 + speech3 + speech4  + speech6 + speech7
        ...
        cnn_grid = cnn_grid0 + cnn_grid1 + cnn_grid2 + cnn_grid3 + cnn_grid4  + cnn_grid6 + cnn_grid7
